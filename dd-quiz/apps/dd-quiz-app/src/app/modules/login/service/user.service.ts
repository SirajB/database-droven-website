...
export class userService {
  ...
  constructor() {
    this._options = {
      ...
      synchronize: true,
      logging: false,
      entities: ['apps/dd-quiz-app/src/core/database/entity/**/*.ts'],
      cli: {
        entitiesDir: 'apps/dd-quiz-app/src/core/database/entity',
      },
    };
    this.connection = createConnection(this._options);
  }
